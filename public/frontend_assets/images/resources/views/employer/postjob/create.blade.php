            ...
            <div class="row orker-form-group">
                <div class="col-md-4">
                    <div class="orker-form-col">
                        ...
                        <input type="text" class="orker-form-control" name="fixed_salary" placeholder="Integer only" value="{{ old('fixed_salary') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                ...
                <div class="col-md-4">
                    <div class="orker-form-col">
                        ...
                        <input type="text" class="orker-form-control" name="variable_salary_from" placeholder="Integer only" value="{{ old('variable_salary_from') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                ...
                <div class="col-md-4">
                    <div class="orker-form-col">
                        ...
                        <input type="text" class="orker-form-control" name="variable_salary_to" placeholder="Integer only" value="{{ old('variable_salary_to') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
            ...
            <div class="row orker-form-group mt-3">
                <div class="col-md-4">
                    <div class="orker-form-col">
                        ...
                        <input type="text" class="orker-form-control" name="petrol_allowance" placeholder="Integer only" value="{{ old('petrol_allowance') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                ...
                <div class="col-md-4">
                    <div class="orker-form-col">
                        ...
                        <input type="text" class="orker-form-control" name="accommodation" placeholder="Integer only" value="{{ old('accommodation') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                ...
                <div class="col-md-4">
                    <div class="orker-form-col">
                        ...
                        <input type="text" class="orker-form-control" name="food_allowance" placeholder="Integer only" value="{{ old('food_allowance') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
