        ...
        <form id="jobForm" action="{{ route('employer.job.update', $job->id) }}" method="POST">
            ...
            <fieldset {{ $isLocked ? 'disabled' : '' }}>
                ...
                <div class="orker-form-group">
                    ...
                    <select class="orker-form-control job-title-select2" name="job_title_id">
                ...
                <div class="orker-form-group">
                    ...
                    <textarea class="orker-form-control orker-form-textarea" name="description" rows="4"
                ...
                <div class="row orker-form-group">
                    ...
                    <div class="col-md-6">
                        <div class="orker-form-col">
                            ...
                            @endphp
                            <select class="orker-form-control" name="years">
                ...
                <div class="row orker-form-group">
                    <div class="col-md-4">
                        <div class="orker-form-col">
                            ...
                            <input type="text" class="orker-form-control" name="fixed_salary" placeholder="Integer only" value="{{ old('fixed_salary', $job->fixed_salary) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    ...
                    <div class="col-md-4">
                        <div class="orker-form-col">
                            ...
                            <input type="text" class="orker-form-control" name="variable_salary_from" placeholder="Integer only" value="{{ old('variable_salary_from', $job->variable_salary_from) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    ...
                    <div class="col-md-4">
                        <div class="orker-form-col">
                            ...
                            <input type="text" class="orker-form-control" name="variable_salary_to" placeholder="Integer only" value="{{ old('variable_salary_to', $job->variable_salary_to) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                ...
                <div class="row orker-form-group mt-3">
                    <div class="col-md-4">
                        <div class="orker-form-col">
                            ...
                            <input type="text" class="orker-form-control" name="petrol_allowance" placeholder="Integer only" value="{{ old('petrol_allowance', $job->petrol_allowance) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    ...
                    <div class="col-md-4">
                        <div class="orker-form-col">
                            ...
                            <input type="text" class="orker-form-control" name="accommodation" placeholder="Integer only" value="{{ old('accommodation', $job->accommodation) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    ...
                    <div class="col-md-4">
                        <div class="orker-form-col">
                            ...
                            <input type="text" class="orker-form-control" name="food_allowance" placeholder="Integer only" value="{{ old('food_allowance', $job->food_allowance) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                ...
                <div class="row orker-form-group">
                    ...
                    <div class="col-md-6">
                        <div class="orker-form-col">
                            ...
                            <select class="orker-form-control" name="status">
            ...
            $('.job-title-select2').select2({
                ...
                if (!$('.select2-results__add-new').length) {
                    ...
                    var $inputForm = $('<div class="select2-results__new-form" style="display: none; padding: 15px; background: #f8fafc; border-bottom: 1px solid #e2e8f0; box-shadow: inset 0 2px 4px 0 rgb(0 0 0 / 0.05);">' +
                        ...
                        '<label style="font-size: 12px; font-weight: 600; color: #475569; margin-bottom: 4px; display: block;">Title Name</label>' +
                        '<input type="text" class="form-control" style="width: 100%; border: 1px solid #cbd5e1; padding: 8px 12px; border-radius: 4px; font-size: 14px; box-sizing: border-box;" id="newJobTitleInput" placeholder="e.g. Senior Laravel Developer">' +
                        '<div id="newJobTitleError" style="color: #dc2626; font-size: 12px; margin-top: 6px; display: none; line-height: 1.4;"></div>' +
                        '</div>' +
                        '<div style="display: flex; gap: 8px;">' +
                            '<button type="button" style="flex: 1; padding: 8px; font-size: 13px; font-weight: 600; background: #003459; color: white; border: none; border-radius: 4px; cursor: pointer; transition: opacity 0.2s;" onmouseover="this.style.opacity=\'0.9\'" onmouseout="this.style.opacity=\'1\'" id="btnCreateJobTitle">Create Title</button>' +
                            '<button type="button" style="flex: 1; padding: 8px; font-size: 13px; font-weight: 600; background: #fff; color: #475569; border: 1px solid #cbd5e1; border-radius: 4px; cursor: pointer; transition: background-color 0.2s;" onmouseover="this.style.backgroundColor=\'#f1f5f9\'" onmouseout="this.style.backgroundColor=\'#fff\'" id="btnCancelJobTitle">Cancel</button>' +
                        '</div>' +
                        '</div>');
