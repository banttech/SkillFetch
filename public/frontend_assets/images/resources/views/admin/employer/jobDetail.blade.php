...
<style>
.supervisor-table tbody td.view-profiles {
    min-width: 208px;
}
</style>
    ...
    <div class="content-card">
        ...
        <div class="job-details-box">
            ...
            <div class="detail-row">
                ...
                <div class="detail-item">
                    <label>Status</label>
                    @if ($job->status)
                         <p class="text-success" style="color:green!important;font-weight:600;">Active</p>
                    @else
           ...
           <div class="detail-row detail-div-rows">
                 <div class="detail-item ">
        ...
        <div class="table-container job-detail-new">
