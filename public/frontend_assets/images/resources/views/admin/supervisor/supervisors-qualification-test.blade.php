...
@section('content')
    ...
    <style>
        ...
        .btn-lightbox-close {
            position:fixed; top:25px; right:40px; background:rgba(239, 68, 68, 0.9); border:none;
            color:#fff; font-size:32px; width:54px; height:54px; border-radius:50%;
    ...
    <div class="content-card">
        ...
        @if (isset($cameraActivities) && $cameraActivities->count() > 0)
            <div class="tab-alert-box" style="margin-top: 20px; border-left: 4px solid #3498db;">
                <div class="tab-alert-header">
                    <div class="tab-alert-header-left">
                        <i class="fas fa-camera tab-alert-icon" style="color: #3498db;"></i>
                        <strong class="tab-alert-title">Camera Activity</strong>
                    </div>
                    <span class="tab-alert-badge" style="background-color: #3498db;">
