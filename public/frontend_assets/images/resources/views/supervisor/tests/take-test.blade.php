...
<style>
    ...
    .question-media img   { max-width:100%; border-radius:10px; border:1px solid #e2e8f0; }
    .question-media video { max-width:100%; border-radius:10px; border:1px solid #e2e8f0; }
    ...
    .warn-modal h4 { font-size:18px; font-weight:700; color:#0E253A; margin:0 0 10px; }
    .warn-modal p  { font-size:14px; color:#5a7284; line-height:1.6; margin:0 0 20px; }
    .btn-wm-ok {
        background:linear-gradient(90deg,#00466D,#0E253A);
        color:#fff; border:none; padding:10px 32px;
        border-radius:8px; font-weight:700; font-size:14px; cursor:pointer;
    }
    .btn-wm-ok:hover { opacity:.88; }
    ...
    .btn-lightbox-close {
        position:fixed; top:25px; right:40px; background:rgba(0,0,0,0.5); border:none;
        color:#fff; font-size:28px; width:48px; height:48px; border-radius:50%;
        cursor:pointer; display:flex; justify-content:center; align-items:center;
        backdrop-filter:blur(4px); transition:all 0.2s ease; z-index:100000;
    }
    ...
    <div class="container-fluid">
        ...
        <div class="camera-container" id="cameraContainer">
            ...
            <div class="camera-error-placeholder">
                ...
                <span id="cameraErrorMessage">Camera Error: Access Denied</span>
            </div>
        </div>
...
<script>
    ...
    if (tabSwitchCount > MAX_TAB_SWITCHES) {
        ...
        showWarnModal(
            'Test Auto-Submitted!',
            'You have exceeded the maximum of 2 tab switches. The test has been submitted automatically.',
            'danger'
        );
        autoSubmitTest();
    }
    ...
    function showWarnModal(title, msg, type = 'warn', onOk = null) {
        ...
        if (backdrop.classList.contains('active')) {
            ...
            msgEl.innerHTML += '<br><br><span style="color:#ef4444; font-weight:bold;">Additional Issue:</span> ' + msg;
            return;
        }
