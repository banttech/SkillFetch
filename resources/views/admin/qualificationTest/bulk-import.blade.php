...
a.btn.btn-submit-donlodas.mt-2 {
    font-size: 13px;
    font-weight: 600;
    background: orange;
    color: #000000;
...
.bulk-dropzone .dz-title  { font-size: .98rem; color: #37474f;     margin: 5px;}
.bulk-dropzone .dz-title strong {
    color: #00466d;
}
.bulk-dropzone .dz-hint {
    font-size: .8rem;
    color: #626262;
    margin-top: .25rem;
    font-weight: 500;
...
.imp-banner.danger h6{
   color: #a80000;
}
.imp-banner.success .bn-body h6 {
    color: #008a06;
}
 .imp-banner.success .bn-icon i{
        color: #008a06;
}.imp-banner.warning .bn-body h6 {
    color: #e47f00;
}
@media(max-width:768px){
.imp-banner.danger {
     margin: 6px 4px;
    padding: 12px;  border-left: 2px solid #e53935;
    flex-wrap: wrap;
}.imp-banner{
 margin: 6px 4px;
}
#file-badge span.icons {
    display: none;
}#file-badge span {
    display: inline-flex;
    align-items: center;
...
<div class="content-card add-quests">
    ...
    @if(session('error'))
        <div class="imp-banner danger">
            <span class="bn-icon"><i class="fas fa-times-circle"></i></span>
            <div class="bn-body">
                <h6>Import Failed</h6>
                <p>{{ session('error') }}</p>
            </div>
    ...
    @if(session()->has('import_success'))
        ...
        @if($successCount > 0)
            <div class="imp-banner success">
                <span class="bn-icon"><i class="fas fa-check-circle"></i>   </span>
                <div class="bn-body">
                ...
                <div class="bn-body">
                    ...
                    @if($failedFile)
                        <a href="{{ route('admin.qualification.bulk-import.download') }}?file={{ urlencode($failedFile) }}"
                           class="btn btn-submit-donlodas mt-2"
                           >
    ...
    <form id="importForm" method="POST"
        ...
        <div class="row g-3">
            <div class="col-12 top-2">
                ...
                <div class="bulk-dropzone" id="dropZone"
                    ...
                    <div class="dz-icon"><img src="{{ asset('admin_assets/images/Document.png') }}" alt="Users"></div>
                    <div class="dz-title">
                        <strong>Click to browse</strong> or drag &amp; drop your Excel file here
                    </div>
                    <div class="dz-hint">Accepted: .xlsx, .xls &nbsp;|&nbsp; Max size: 10 MB</div>
                    <div id="file-badge">
                        <span><span class="icons">📎</span><span id="badge-text"></span></span>
                    </div>
                </div>
        ...
        <div class="">
            <div class="div-flexs">
                ...
                <button type="submit" class="btn btn-submit-form" id="importBtn" disabled>
