...
.supervisor-table tbody td.btn-widths {
    min-width: 246px;
    ...
    <div class="content-card">
        ...
        <div class="table-container supervisor-ads-tab">
                ...
                <tbody>
                    ...
                    @forelse ($jobs as $job)
                        <tr>
                            ...
                            <td class="btn-widths"><a href="{{route('employer.jobApplication',$job->id)}}" class="btn-view">View Job Application <span
