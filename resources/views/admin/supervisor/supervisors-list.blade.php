...
@section('content')
  ...
  <style>
    ...
    <div class="content-card supervisors">
                   ...
                   <div class="col-md-3">
                    ...
                    {{-- Action Buttons --}}
                     <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('admin.supervisor.supervisors-List') }}" class="btn btn-secondary" title="Reset">
        ...
        <div class="table-container">
            <table class="supervisor-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center text-muted text-danger" style="padding:40px;">
