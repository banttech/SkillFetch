...
@section('content')
<style>
.btn.btn-submit-form.bg-red {
    background: #d82525!important;
}</style>
    <div class="content-card">

        <div class="div-main-haeds">
            <h2 class="page-title">Edit Test</h2>
        </div>
        @if (session('success'))
        ...
        <form class="add-ques" action="{{ route('admin.test.update', $test->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" name="fees" value="{{ old('fees', (int)$test->fees) }}"
                ...
                <div class="col-12 col-md-12 top-2">
                    ...
                    <select name="timing" class="custom-input form-control">
                        ...
                        @foreach ([60, 75, 90] as $t)
                            <option value="{{ $t }}" {{ old('timing', $test->timing) == $t ? 'selected' : '' }}>
                                {{ $t }} Minutes
                            </option>
                        @endforeach
                    </select>
               ...
               <div class="col-12"><hr><h4 class="test-config mt-3 mb-4">Text Questions Configuration</h4></div>
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" name="text_marks" value="{{ old('text_marks', (int)$test->text_marks) }}"
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" name="text_q_per_dept" value="{{ old('text_q_per_dept', (int)$test->text_q_per_dept) }}"
               ...
               <div class="col-12"><hr><h4 class="test-config mt-3 mb-4">Single Select Questions Configuration</h4></div>

                <div class="col-12 col-md-6 top-2">
                    <label>Marks per Single Select Question <span class="text-danger">*</span></label>
                    <input type="number" name="single_select_marks" value="{{ old('single_select_marks', (int)$test->single_select_marks) }}"
                        class="custom-input form-control" placeholder="Enter Marks per question" step="1" min="0">
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" name="single_select_q_per_dept" value="{{ old('single_select_q_per_dept', (int)$test->single_select_q_per_dept) }}"
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" name="multi_select_marks" value="{{ old('multi_select_marks', (int)$test->multi_select_marks) }}"
                        class="custom-input form-control" placeholder="Enter Marks per question" step="1" min="0">
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" name="multi_select_q_per_dept" value="{{ old('multi_select_q_per_dept', (int)$test->multi_select_q_per_dept) }}"
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" name="image_marks" value="{{ old('image_marks', (int)$test->image_marks) }}"
                        class="custom-input form-control" placeholder="Enter Marks per question" step="1" min="0">
                    @error('image_marks')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" name="image_q_per_dept" value="{{ old('image_q_per_dept', (int)$test->image_q_per_dept) }}"
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" name="video_marks" value="{{ old('video_marks', (int)$test->video_marks) }}"
                        class="custom-input form-control" placeholder="Enter Marks per question" step="1" min="0">
                    @error('video_marks')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" name="video_q_per_dept" value="{{ old('video_q_per_dept', (int)$test->video_q_per_dept) }}"
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" id="no_of_departments" name="no_of_departments"
                        value="{{ old('no_of_departments', (int)$test->no_of_departments) }}"
                        class="custom-input form-control" placeholder="No. of Departments" readonly step="1" min="0">
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" id="question_per_dept" name="question_per_department"
                        value="{{ old('question_per_department', (int)$test->question_per_department) }}"
                        class="custom-input form-control" placeholder="Auto-calculated" readonly step="1" min="0">
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" id="total_questions" name="total_question"
                        value="{{ old('total_question', (int)$test->total_question) }}"
                ...
                <div class="col-12 col-md-6 top-2">
                    ...
                    <input type="number" id="total_marks" name="total_marks"
                        value="{{ old('total_marks', (int)$test->total_marks) }}"
                        class="custom-input form-control" readonly step="1" min="0">
                    @error('total_marks')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="col-6 col-md-6 top-2">
                    ...
                    <input type="number" name="passing_marks"
                        value="{{ old('passing_marks', (int)$test->passing_marks) }}"
            ...
            <button type="submit" class="btn btn-submit-form">Update Test</button>
            <a href="{{ route('admin.test.index') }}" class="btn btn-submit-form bg-red">Cancel</a>
        </form>
...
$(document).ready(function() {
    ...
    function calculateTotals() {
        ...
        // Questions per department = sum of all types
        ...
        // Total questions
        $('#total_questions').val(questionsPerDept * totalDepartments);

        // Total marks = (marks * q_per_dept per type) * departments
        const totalMarks = (
    ...
    // Bind calculation to mark/question fields
    ...
    // Run on page load so all summary fields show correctly
    calculateTotals();
    ...
    $('.add-ques').validate({
        rules: {
            ...
            fees:                    { required: true, integer: true, min: 0 },
            timing:                  { required: true },
            text_marks:              { required: true, integer: true, min: 0 },
            text_q_per_dept:         { required: true, integer: true, min: 0 },
            single_select_marks:     { required: true, integer: true, min: 0 },
            single_select_q_per_dept:{ required: true, integer: true, min: 0 },
            multi_select_marks:      { required: true, integer: true, min: 0 },
            multi_select_q_per_dept: { required: true, integer: true, min: 0 },
            image_marks:             { required: true, integer: true, min: 0 },
            image_q_per_dept:        { required: true, integer: true, min: 0 },
            video_marks:             { required: true, integer: true, min: 0 },
            video_q_per_dept:        { required: true, integer: true, min: 0 },
            no_of_departments:       { required: true, integer: true, min: 1 },
            question_per_department: { required: true, integer: true, min: 1 },
            total_question:          { required: true, integer: true, min: 1 },
            total_marks:             { required: true, integer: true, min: 1 },
            passing_marks: {
                required: true,
                integer: true,
                min: 0,
                max: function() { return parseInt($('#total_marks').val()) || 0; }
            }
        },
        messages: {
            name:             { required: "Please enter test name", minlength: "Min 3 characters", maxlength: "Max 255 characters" },
            fees:             { required: "Please enter test fee", integer: "Whole numbers only", min: "Cannot be negative" },
            timing:           { required: "Please select test timing" },
            text_marks:              { required: "Required", integer: "Whole numbers only", min: "Cannot be negative" },
            text_q_per_dept:         { required: "Required", integer: "Whole numbers only", min: "Cannot be negative" },
            single_select_marks:     { required: "Required", integer: "Whole numbers only", min: "Cannot be negative" },
            single_select_q_per_dept:{ required: "Required", integer: "Whole numbers only", min: "Cannot be negative" },
            multi_select_marks:      { required: "Required", integer: "Whole numbers only", min: "Cannot be negative" },
            multi_select_q_per_dept: { required: "Required", integer: "Whole numbers only", min: "Cannot be negative" },
            image_marks:             { required: "Required", integer: "Whole numbers only", min: "Cannot be negative" },
            image_q_per_dept:        { required: "Required", integer: "Whole numbers only", min: "Cannot be negative" },
            video_marks:             { required: "Required", integer: "Whole numbers only", min: "Cannot be negative" },
            video_q_per_dept:        { required: "Required", integer: "Whole numbers only", min: "Cannot be negative" },
            no_of_departments:       { required: "Required", integer: "Whole numbers only", min: "At least 1" },
            question_per_department: { required: "Required", integer: "Whole numbers only", min: "At least 1" },
            total_question:          { required: "Required", integer: "Whole numbers only", min: "At least 1" },
            total_marks:             { required: "Required", integer: "Whole numbers only", min: "At least 1" },
            passing_marks:           { required: "Please enter passing marks", integer: "Whole numbers only", min: "Cannot be negative", max: "Must be less than total marks" }
        },
        errorElement: 'span',
